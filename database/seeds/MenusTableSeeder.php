...
class MenusTableSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      Menu::create([
        ...
        'menu_type' => false,
        'menu_price' => '10000',
        'menu_description' => 'Soto Ayam Lamongan Bu Kana.. Telah berdiri sejak 1983, Soto ayam bu Kana telah setia melayani civitas akademika dan terjamin kualitas rasanya',
      ...
      Menu::create([
        ...
        'menu_type' => false,
        'menu_price' => '13000',
        'menu_description' => 'Soto Ayam Lamongan Bu Kana.. Telah berdiri sejak 1983,Soto ayam bu Kana telah setia melayani civitas akademika dan terjamin kualitas rasanya. TERSEDIA JUGA PORSI JUMBO!!!',
